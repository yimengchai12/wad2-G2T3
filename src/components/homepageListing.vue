<template>
    ...
    <div class="d-flex" style="overflow:hidden; padding-top:1px;padding-bottom:1px;">
        
        <div v-for="imag in imagesObj" :key="imag" class="me-5">
            <div class="card homepageListing" style="height:400px;">
                <img :src="imag.image" class="card-img-top img-fluid" alt="">
                <div class="card-body">
